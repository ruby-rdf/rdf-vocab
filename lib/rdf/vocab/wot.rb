...
module RDF::Vocab
  ...
  class WOT < RDF::StrictVocabulary("http://xmlns.com/wot/0.1/")
    ...
    term :EncryptedDocument,
      ...
      :"owl:disjointWith" => [%(wot:SigEvent).freeze, %(wot:PubKey).freeze, %(wot:Endorsement).freeze, %(wot:User).freeze],
      :"rdfs:isDefinedBy" => %(wot:).freeze,
      subClassOf: ["http://xmlns.com/wordnet/1.6/Endorsement-4".freeze, "foaf:Document".freeze],
      type: "owl:Class".freeze,
      :"vs:term_status" => %(unstable).freeze
    term :Endorsement,
      comment: %(An endorsement resource containing a detached ascii signature.).freeze,
      label: "Endorsement".freeze,
      :"owl:disjointWith" => [%(wot:SigEvent).freeze, %(wot:EncryptedDocument).freeze, %(wot:PubKey).freeze, %(wot:User).freeze],
      :"rdfs:isDefinedBy" => %(wot:).freeze,
      subClassOf: ["http://xmlns.com/wordnet/1.6/Endorsement-4".freeze, "foaf:Document".freeze],
      type: "owl:Class".freeze,
      :"vs:term_status" => %(unstable).freeze
    term :PubKey,
      ...
      :"owl:disjointWith" => [%(wot:SigEvent).freeze, %(wot:EncryptedDocument).freeze, %(wot:Endorsement).freeze, %(wot:User).freeze],
      :"rdfs:isDefinedBy" => %(wot:).freeze,
    ...
    term :SigEvent,
      ...
      :"owl:disjointWith" => [%(wot:User).freeze, %(wot:EncryptedDocument).freeze, %(wot:PubKey).freeze, %(wot:Endorsement).freeze],
      :"rdfs:isDefinedBy" => %(wot:).freeze,
      subClassOf: ["http://xmlns.com/wordnet/1.6/Event".freeze, "http://www.w3.org/2002/12/cal/ical#Vevent".freeze],
      type: "owl:Class".freeze,
      :"vs:term_status" => %(testing).freeze
    term :User,
      comment: %(A user \(agent, person, group or organization\) of a PGP/GPG public key.).freeze,
      label: "Key User".freeze,
      :"owl:disjointWith" => [%(wot:SigEvent).freeze, %(wot:EncryptedDocument).freeze, %(wot:PubKey).freeze, %(wot:Endorsement).freeze],
      :"rdfs:isDefinedBy" => %(wot:).freeze,
    ...
    property :fingerprint,
      ...
      :"rdfs:isDefinedBy" => %(wot:).freeze,
      type: ["owl:InverseFunctionalProperty".freeze, "owl:DatatypeProperty".freeze],
      :"vs:term_status" => %(testing).freeze
    property :hasKey,
    ...
    term :"",
      ...
      label: "".freeze,
      :"owl:imports" => [%(http://www.w3.org/2002/07/owl).freeze, %(http://www.w3.org/2000/01/rdf-schema).freeze],
