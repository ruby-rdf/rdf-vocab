...
module RDF::Vocab
  ...
  RDAU = Class.new(RDF::StrictVocabulary("http://rdaregistry.info/Elements/u")) do
    ...
    property :"/P60081",
      ...
      "skos:scopeNote": "Numbering may include dates or other timespans, alphanumeric or other characters, and an accompanying caption.".freeze,
      type: "rdf:Property".freeze
    property :"/P60082",
    ...
    property :"/P60371",
      ...
      "skos:scopeNote": "Writing of lyrics in collaboration with a composer to form an original resource is excluded.. (Deprecated)".freeze,
    ...
    property :"/P60398",
      ...
      "skos:scopeNote": "Contributors include editors, translators, arrangers of music, performers, etc.. (Deprecated)".freeze,
      type: "rdf:Property".freeze
    property :"/P60399",
