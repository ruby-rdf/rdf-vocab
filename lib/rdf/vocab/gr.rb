...
module RDF::Vocab
  ...
  GR = Class.new(RDF::StrictVocabulary("http://purl.org/goodrelations/v1#")) do
    ...
    term :ActualProductOrServiceInstance,
      ...
      label: {en: "Actual product or service instance (DEPRECATED)"},
      subClassOf: "http://purl.org/goodrelations/v1#ProductOrService",
      type: "http://www.w3.org/2002/07/owl#Class"
    term :Brand,
      comment: {en: "A brand is the identity of a specific product, service, or business. Use foaf:logo for attaching a brand logo and gr:name or rdfs:label for attaching the brand name.\t\n\n(Source: Wikipedia, the free encyclopedia, see http://en.wikipedia.org/wiki/Brand)"},
    ...
    term :BusinessFunction,
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Business function"},
      type: "http://www.w3.org/2002/07/owl#Class"
    term :DayOfWeek,
      comment: {en: "The day of the week, used to specify  to which day the opening hours of a gr:OpeningHoursSpecification refer.\n\nExamples: Monday, Tuesday, Wednesday,..."},
    ...
    term :OpeningHoursSpecification,
      comment: {en: "This is a conceptual entity that holds together all information about the opening hours on a given day (gr:DayOfWeek)."},
    ...
    term :PaymentMethodCreditCard,
      comment: {en: "The subclass of gr:PaymentMethod represents all variants and brands of credit or debit cards as a standardized procedure for transferring the monetary amount for a purchase. It is mostly used for specifying the types of payment accepted by a gr:Business Entity.\n\nExamples: VISA, MasterCard, or American Express."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Payment method credit card"},
      subClassOf: "http://purl.org/goodrelations/v1#PaymentMethod",
      type: "http://www.w3.org/2002/07/owl#Class"
    term :PriceSpecification,
      comment: {en: "The superclass of all price specifications."},
    ...
    property :acceptedPaymentMethods,
      comment: {en: "The gr:PaymentMethod or methods accepted by the gr:BusinessEntity for the given gr:Offering."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
    ...
    property :availabilityEnds,
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "availability ends (0..1)"},
      range: "http://www.w3.org/2001/XMLSchema#dateTime",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :availabilityStarts,
      comment: {en: "This property specifies the beginning of the availability of the gr:ProductOrService included in the gr:Offering.\nThe difference to the properties gr:validFrom and gr:validThrough is that those specify the period of time during which the offer is valid and can be accepted.\n\nExample: I offer to lease my boat for the period of August 1 - August 31, 2010, but you must accept by offer no later than July 15.\n\nA time-zone should be specified. For a time in GMT/UTC, simply add a \"Z\" following the time:\n\n2008-05-30T09:30:10Z.\n\nAlternatively, you can specify an offset from the UTC time by adding a positive or negative time following the time:\n\n2008-05-30T09:30:10-09:00\n\nor\n\n2008-05-30T09:30:10+09:00.\n\nNote: There is another property gr:availableAtOrFrom, which is used to indicate the gr:Location (e.g. store or shop) from which the goods would be available."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#Offering", term(
            subClassOf: "http://purl.org/goodrelations/v1#Offering",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "availability starts (0..1)"},
      range: "http://www.w3.org/2001/XMLSchema#dateTime",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :availableAtOrFrom,
      comment: {en: "This states that a particular gr:Offering is available at or from the given gr:Location (e.g. shop or branch)."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#Offering", term(
            subClassOf: "http://purl.org/goodrelations/v1#Offering",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "available at or from (0..*)"},
      range: "http://purl.org/goodrelations/v1#Location",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :availableDeliveryMethods,
      comment: {en: "This specifies the gr:DeliveryMethod or methods available for a given gr:Offering."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#Offering", term(
            subClassOf: "http://purl.org/goodrelations/v1#Offering",
    ...
    property :closes,
      ...
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :color,
      comment: {en: "The color of the product."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
      ...
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :condition,
      comment: {en: "A textual description of the condition of the product or service, or the products or services included in the offer (when attached to a gr:Offering)"},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
    ...
    property :deliveryLeadTime,
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "delivery lead time (0..1)"},
      range: "http://purl.org/goodrelations/v1#QuantitativeValueInteger",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :depth,
      comment: {en: "The depth of the product.\nTypical unit code(s): CMT for centimeters, INH for inches"},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#ProductOrService", term(
            equivalentClass: "http://purl.org/goodrelations/v1#ProductOrService",
    ...
    property :eligibleCustomerTypes,
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "eligible customer types (0..*)"},
    ...
    property :eligibleTransactionVolume,
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "eligible transaction volume (0..1)"},
      range: "http://purl.org/goodrelations/v1#PriceSpecification",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :equal,
      comment: {en: "This ordering relation for qualitative values indicates that the subject is equal to the object."},
    ...
    property :greater,
      comment: {en: "This ordering relation for qualitative values indicates that the subject is greater than the object."},
      domain: "http://purl.org/goodrelations/v1#QualitativeValue",
    ...
    property :greaterOrEqual,
      comment: {en: "This ordering relation for qualitative values indicates that the subject is greater than or equal to the object."},
      domain: "http://purl.org/goodrelations/v1#QualitativeValue",
      inverseOf: "http://purl.org/goodrelations/v1#lesserOrEqual",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "greater or equal (0..*)"},
      range: "http://purl.org/goodrelations/v1#QualitativeValue",
      type: ["http://www.w3.org/2002/07/owl#ObjectProperty", "http://www.w3.org/2002/07/owl#TransitiveProperty"]
    property :hasBrand,
      comment: {en: "This specifies the brand or brands (gr:Brand) associated with a gr:ProductOrService, or the brand or brands maintained by a gr:BusinessEntity."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
    ...
    property :hasEligibleQuantity,
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has eligible quantity (0..1)"},
      range: "http://purl.org/goodrelations/v1#QuantitativeValue",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :"hasGTIN-14",
      comment: {en: "The Global Trade Item Number (GTIN-14) of the given gr:ProductOrService or gr:Offering."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#Offering", "http://purl.org/goodrelations/v1#ProductOrService", term(
            equivalentClass: "http://purl.org/goodrelations/v1#ProductOrService",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has GTIN-14 (0..*)"},
      range: "http://www.w3.org/2001/XMLSchema#string",
      subPropertyOf: "http://schema.org/productID",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :"hasGTIN-8",
      comment: {en: "The 8-digit Global Trade Item Number (GTIN-8) of the given gr:ProductOrService or gr:Offering, also known as EAN/UCC-8 (8-digit EAN)."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#Offering", "http://purl.org/goodrelations/v1#ProductOrService", term(
            equivalentClass: "http://purl.org/goodrelations/v1#ProductOrService",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has GTIN-8 (0..*)"},
      range: "http://www.w3.org/2001/XMLSchema#string",
      subPropertyOf: "http://schema.org/productID",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :hasGlobalLocationNumber,
      comment: {en: "The Global Location Number (GLN, sometimes also referred to as International Location Number or ILN) of the respective gr:BusinessEntity or gr:Location.\nThe Global Location Number is a thirteen-digit number used to identify parties and physical locations."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has Global Location Number (0..1)"},
      range: "http://www.w3.org/2001/XMLSchema#string",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :hasISICv4,
      comment: {en: "The International Standard of Industrial Classification of All Economic Activities (ISIC), Revision 4 code for a particular gr:BusinessEntity or gr:Location. See http://unstats.un.org/unsd/cr/registry/isic-4.asp for more information.\n\nNote: While ISIC codes are sometimes misused for classifying products or services, they are designed and suited only for classifying business establishments."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#BusinessEntity", "http://purl.org/goodrelations/v1#Location", term(
            subClassOf: "http://purl.org/goodrelations/v1#BusinessEntity",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has ISIC v4 (0..*)"},
      range: "http://www.w3.org/2001/XMLSchema#int",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :hasInventoryLevel,
      comment: {en: "This property specifies the current approximate inventory level for gr:SomeItems. The unit of measurement and the point value or interval are indicated using the attached gr:QuantitativeValueFloat instance.\n\nThis property can also be attached to a gr:Offering in cases where the included products are not modeled in more detail."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has inventory level (0..1)"},
    ...
    property :hasMakeAndModel,
      comment: {en: "This states that an actual product instance (gr:Individual) or a placeholder instance for multiple, unidentified such instances (gr:SomeItems) is one occurence of a particular gr:ProductOrServiceModel.\n\nExample: myFordT hasMakeAndModel FordT."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has make and model (0..1)"},
      range: "http://purl.org/goodrelations/v1#ProductOrServiceModel",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :hasManufacturer,
      comment: {en: "This object property links a gr:ProductOrService to the gr:BusinessEntity that produces it. Mostly used with gr:ProductOrServiceModel."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#ProductOrService", term(
            equivalentClass: "http://purl.org/goodrelations/v1#ProductOrService",
    ...
    property :hasOpeningHoursSpecification,
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has opening hours specification (0..*)"},
      range: "http://purl.org/goodrelations/v1#OpeningHoursSpecification",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :hasPOS,
      comment: {en: "This property states that the respective gr:Location is a point of sale for the respective gr:BusinessEntity. It allows linking those two types of entities without the need for a particular gr:Offering."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#BusinessEntity", term(
            subClassOf: "http://purl.org/goodrelations/v1#BusinessEntity",
    ...
    property :hasStockKeepingUnit,
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has Stock Keeping Unit (0..*)"},
      range: "http://www.w3.org/2001/XMLSchema#string",
      subPropertyOf: "http://schema.org/productID",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :hasUnitOfMeasurement,
      comment: {en: "The unit of measurement for a gr:QuantitativeValue, a gr:UnitPriceSpecification, or a gr:TypeAndQuantityNode given using the UN/CEFACT Common Code (3 characters)."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has unit of measurement (1..1)"},
      range: "http://www.w3.org/2001/XMLSchema#string",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :hasValue,
      comment: {en: "This subproperty specifies that the upper and lower limit of the given gr:QuantitativeValue are identical and have the respective value. It is a shortcut for such cases where a quantitative property is (at least practically) a single point value and not an interval."},
      domain: "http://purl.org/goodrelations/v1#QuantitativeValue",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has value (0..1)"},
      range: "http://www.w3.org/2000/01/rdf-schema#Literal",
    ...
    property :hasValueFloat,
      comment: {en: "This subproperty specifies that the upper and lower limit of the given gr:QuantitativeValueFloat are identical and have the respective float value. It is a shortcut for such cases where a quantitative property is (at least practically) a single point value and not an interval."},
      domain: "http://purl.org/goodrelations/v1#QuantitativeValueFloat",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has value float (0..1)"},
      range: "http://www.w3.org/2001/XMLSchema#float",
    ...
    property :hasValueInteger,
      comment: {en: "This subproperty specifies that the upper and lower limit of the given gr:QuantitativeValueInteger are identical and have the respective integer value. It is a shortcut for such cases where a quantitative property is (at least practically) a single point value and not an interval."},
      domain: "http://purl.org/goodrelations/v1#QuantitativeValueInteger",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has value integer (0..1)"},
      range: "http://www.w3.org/2001/XMLSchema#int",
    ...
    property :hasWarrantyPromise,
      comment: {en: "This specifies the gr:WarrantyPromise made by the gr:BusinessEntity for the given gr:Offering."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#Offering", term(
            subClassOf: "http://purl.org/goodrelations/v1#Offering",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has warranty promise (0..*)"},
      range: "http://purl.org/goodrelations/v1#WarrantyPromise",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :hasWarrantyScope,
      comment: {en: "This states the gr:WarrantyScope of a given gr:WarrantyPromise."},
      domain: "http://purl.org/goodrelations/v1#WarrantyPromise",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "has warranty scope (0..1)"},
      range: "http://purl.org/goodrelations/v1#WarrantyScope",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :height,
      comment: {en: "The height of the product.\nTypical unit code(s): CMT for centimeters, INH for inches"},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#ProductOrService", term(
            equivalentClass: "http://purl.org/goodrelations/v1#ProductOrService",
    ...
    property :includesObject,
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "includes object (0..*)"},
      range: "http://purl.org/goodrelations/v1#TypeAndQuantityNode",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :isAccessoryOrSparePartFor,
      comment: {en: "This states that a particular gr:ProductOrService is an accessory or spare part for another product or service."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#ProductOrService", term(
            equivalentClass: "http://purl.org/goodrelations/v1#ProductOrService",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "is accessory or spare part for (0..*)"},
      range: "http://purl.org/goodrelations/v1#ProductOrService",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :isConsumableFor,
      comment: {en: "This states that a particular gr:ProductOrService is a consumable for another product or service."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#ProductOrService", term(
            equivalentClass: "http://purl.org/goodrelations/v1#ProductOrService",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "is consumable for (0..*)"},
      range: "http://purl.org/goodrelations/v1#ProductOrService",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :isListPrice,
      comment: {en: "This boolean attribute indicates whether a gr:UnitPriceSpecification is a list price (usually a vendor recommendation) or not. \"true\"  indicates it is a list price, \"false\" indicates it is not.\nDEPRECATED. Use the gr:priceType property instead."},
      domain: "http://purl.org/goodrelations/v1#UnitPriceSpecification",
      "http://www.w3.org/2002/07/owl#deprecated": "true",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "is list price (DEPRECATED)"},
      range: "http://www.w3.org/2001/XMLSchema#boolean",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :isSimilarTo,
      comment: {en: "This states that a given gr:ProductOrService is similar to another product or service. Of course, this is a subjective statement; when interpreting it, the trust in the origin of the statement should be taken into account."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#ProductOrService", term(
            equivalentClass: "http://purl.org/goodrelations/v1#ProductOrService",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "is similar to (0..*)"},
      range: "http://purl.org/goodrelations/v1#ProductOrService",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :isVariantOf,
      comment: {en: "This states that a particular gr:ProductOrServiceModel is a variant of another product or service model. It is pretty safe to infer that the variant inherits all gr:quantitativeProductOrServiceProperty, gr:qualitativeProductOrServiceProperty, and gr:datatypeProductOrServiceProperty values that are defined for the first gr:ProductOrServiceModel.\n\nExample:\nfoo:Red_Ford_T_Model gr:isVariantOf foo:Ford_T_Model"},
      domain: "http://purl.org/goodrelations/v1#ProductOrServiceModel",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "is variant of (0..1)"},
      range: "http://purl.org/goodrelations/v1#ProductOrServiceModel",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :legalName,
      comment: {en: "The legal name of the gr:BusinessEntity."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#BusinessEntity", term(
            subClassOf: "http://purl.org/goodrelations/v1#BusinessEntity",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "legal name (0..1)"},
      range: "http://www.w3.org/2000/01/rdf-schema#Literal",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :lesser,
      comment: {en: "This ordering relation for gr:QualitativeValue pairs indicates that the subject is lesser than the object."},
      domain: "http://purl.org/goodrelations/v1#QualitativeValue",
    ...
    property :lesserOrEqual,
      comment: {en: "This ordering relation for gr:QualitativeValue pairs indicates that the subject is lesser than or equal to the object."},
      domain: "http://purl.org/goodrelations/v1#QualitativeValue",
      inverseOf: "http://purl.org/goodrelations/v1#greaterOrEqual",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "lesser or equal (0..*)"},
      range: "http://purl.org/goodrelations/v1#QualitativeValue",
      type: ["http://www.w3.org/2002/07/owl#ObjectProperty", "http://www.w3.org/2002/07/owl#TransitiveProperty"]
    property :name,
      comment: {en: "A short text describing the respective resource.\n\nThis property is semantically equivalent to dcterms:title and rdfs:label and just meant as a handy shortcut for marking up data."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://www.w3.org/2002/07/owl#Thing", "http://purl.org/goodrelations/v1#Brand", "http://purl.org/goodrelations/v1#BusinessEntity", "http://purl.org/goodrelations/v1#BusinessEntityType", "http://purl.org/goodrelations/v1#BusinessFunction", "http://purl.org/goodrelations/v1#DayOfWeek", "http://purl.org/goodrelations/v1#DeliveryChargeSpecification", "http://purl.org/goodrelations/v1#DeliveryMethod", "http://purl.org/goodrelations/v1#DeliveryModeParcelService", "http://purl.org/goodrelations/v1#Individual", "http://purl.org/goodrelations/v1#Location", "http://purl.org/goodrelations/v1#Offering", "http://purl.org/goodrelations/v1#OpeningHoursSpecification", "http://purl.org/goodrelations/v1#PaymentChargeSpecification", "http://purl.org/goodrelations/v1#PaymentMethod", "http://purl.org/goodrelations/v1#PaymentMethodCreditCard", "http://purl.org/goodrelations/v1#PriceSpecification", "http://purl.org/goodrelations/v1#ProductOrService", "http://purl.org/goodrelations/v1#ProductOrServiceModel", "http://purl.org/goodrelations/v1#QualitativeValue", "http://purl.org/goodrelations/v1#QuantitativeValue", "http://purl.org/goodrelations/v1#QuantitativeValueFloat", "http://purl.org/goodrelations/v1#QuantitativeValueInteger", "http://purl.org/goodrelations/v1#SomeItems", "http://purl.org/goodrelations/v1#TypeAndQuantityNode", "http://purl.org/goodrelations/v1#UnitPriceSpecification", "http://purl.org/goodrelations/v1#WarrantyPromise", "http://purl.org/goodrelations/v1#WarrantyScope")
        ),
      ...
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :nonEqual,
      comment: {en: "This ordering relation for gr:QualitativeValue pairs indicates that the subject is not equal to the object."},
      domain: "http://purl.org/goodrelations/v1#QualitativeValue",
      inverseOf: "http://purl.org/goodrelations/v1#nonEqual",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "non equal (0..*)"},
      range: "http://purl.org/goodrelations/v1#QualitativeValue",
      type: ["http://www.w3.org/2002/07/owl#ObjectProperty", "http://www.w3.org/2002/07/owl#SymmetricProperty"]
    property :offers,
      comment: {en: "This links a gr:BusinessEntity to the offers (gr:Offering) it makes. If you want to express interest in receiving offers, use gr:seeks instead."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#BusinessEntity", term(
            subClassOf: "http://purl.org/goodrelations/v1#BusinessEntity",
    ...
    property :opens,
      ...
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :owns,
      comment: {en: "This property indicates that a particular person or business owns a particular product. It can be used to expose the products in one's posession in order to empower recommender systems to suggest matching offers.\n\nNote that the product must be an instance of the class gr:Individual.\n\nThis property can also be safely applied to foaf:Agent instances."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#BusinessEntity", term(
            subClassOf: "http://purl.org/goodrelations/v1#BusinessEntity",
    ...
    property :predecessorOf,
      comment: {en: "This property indicates that the subject is a previous, often discontinued variant of the gr:ProductOrServiceModel used as the object.\n\nExample: Golf III predecessorOf Golf IV\n\nThis relation is transitive."},
      domain: "http://purl.org/goodrelations/v1#ProductOrServiceModel",
      inverseOf: "http://purl.org/goodrelations/v1#successorOf",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "predecessor of (0..*)"},
      range: "http://purl.org/goodrelations/v1#ProductOrServiceModel",
      type: ["http://www.w3.org/2002/07/owl#ObjectProperty", "http://www.w3.org/2002/07/owl#TransitiveProperty"]
    property :priceType,
      comment: {en: "This attribute can be used to distinguish multiple different price specifications for the same gr:Offering. It supersedes the former gr:isListPrice property. The following values are recommended:\n\nThe absence of this property marks the actual sales price.\n\nSRP: \"suggested retail price\" - applicable for all sorts of a non-binding retail price recommendations, e.g. such published by the manufacturer or the distributor. This value replaces the former gr:isListPrice property.\n\nINVOICE: The invoice price, mostly used in the car industry - this is the price a dealer pays to the manufacturer, excluding rebates and charges."},
      domain: "http://purl.org/goodrelations/v1#UnitPriceSpecification",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "price type (0..1)"},
      range: "http://www.w3.org/2001/XMLSchema#string",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :qualitativeProductOrServiceProperty,
      comment: {en: "This is the super property of all qualitative properties for products and services. All properties in product or service ontologies for which gr:QualitativeValue instances are specified are subproperties of this property."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#ProductOrService", term(
            equivalentClass: "http://purl.org/goodrelations/v1#ProductOrService",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "qualitative product or service property (0..*)"},
      range: "http://purl.org/goodrelations/v1#QualitativeValue",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :quantitativeProductOrServiceProperty,
      comment: {en: "This is the super property of all quantitative  properties for products and services. All properties in product or service ontologies that specify quantitative characteristics, for which an interval is at least theoretically an appropriate value, are subproperties of this property."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#ProductOrService", term(
            equivalentClass: "http://purl.org/goodrelations/v1#ProductOrService",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "quantitative product or service property (0..*)"},
      range: "http://purl.org/goodrelations/v1#QuantitativeValue",
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :relatedWebService,
      comment: {en: "The URI of a SOAP or REST Web Service from which additional information about the gr:BusinessEntity, gr:Offering, gr:PriceSpecification, or gr:ProductOrService, or any other element,  can be obtained. The recommended range is xsd:anyURI i.e., the URI of a SOAP or REST Web Service.\n\nIn principle, any existing or upcoming vocabulary for Web Services can be used in combination with GoodRelations, because the association between (a) the service description and (b) the GoodRelations description can be found via the Web Service URI value used with this gr:relatedWebService property."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "related Web Service (0..*)"},
      type: "http://www.w3.org/2002/07/owl#AnnotationProperty"
    property :seeks,
      comment: {en: "This links a gr:BusinessEntity to gr:Offering nodes that describe what the business entity is interested in (i.e., the buy side). If you want to express interest in offering something, use gr:offers instead. Note that this substitutes the former gr:BusinessFunction gr:Buy, which is now deprecated."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#BusinessEntity", term(
            subClassOf: "http://purl.org/goodrelations/v1#BusinessEntity",
    ...
    property :serialNumber,
      comment: {en: "The serial number or any alphanumeric identifier of a particular product. Note that serial number are unique only for the same brand or the same model, so you cannot infer from two occurrences of the same serial number that the objects to which they are attached are identical.\n\nThis property can also be attached to a gr:Offering in cases where the included products are not modeled in more detail."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "serial number (0..*)"},
      range: "http://www.w3.org/2001/XMLSchema#string",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :successorOf,
      comment: {en: "This property indicates that the subject is a newer, often updated or improved variant of the gr:ProductOrServiceModel used as the object.\n\nExample: Golf III successorOf Golf II\n\nThis relation is transitive."},
      domain: "http://purl.org/goodrelations/v1#ProductOrServiceModel",
      inverseOf: "http://purl.org/goodrelations/v1#predecessorOf",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "successor of (0..*)"},
      range: "http://purl.org/goodrelations/v1#ProductOrServiceModel",
      type: ["http://www.w3.org/2002/07/owl#ObjectProperty", "http://www.w3.org/2002/07/owl#TransitiveProperty"]
    property :taxID,
      comment: {en: "The Tax / Fiscal ID of the gr:BusinessEntity, e.g. the TIN in the US or the CIF/NIF in Spain. It is usually assigned by the country of residence"},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#BusinessEntity", term(
            subClassOf: "http://purl.org/goodrelations/v1#BusinessEntity",
      ...
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :typeOfGood,
      comment: {en: "This specifies the gr:ProductOrService that the gr:TypeAndQuantityNode is referring to."},
      domain: "http://purl.org/goodrelations/v1#TypeAndQuantityNode",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "type of good (1..1)"},
      range: term(
          type: "http://www.w3.org/2002/07/owl#Class",
    ...
    property :validFrom,
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "valid from (0..1)"},
      range: "http://www.w3.org/2001/XMLSchema#dateTime",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :validThrough,
      comment: {en: "This property specifies the end of the validity of the gr:Offering, gr:PriceSpecification, gr:License, or gr:OpeningHoursSpecification.\nA time-zone should be specified. For a time in GMT/UTC, simply add a \"Z\" following the time:\n\n2008-05-30T09:30:10Z.\n\nAlternatively, you can specify an offset from the UTC time by adding a positive or negative time following the time:\n\n2008-05-30T09:30:10-09:00\n\nor\n2008-05-30T09:30:10+09:00.\n\nNote 1: If multiple contradicting instances of a gr:Offering, gr:PriceSpecification, or gr:OpeningHoursSpecification exist, it is a good heuristics to assume that\n1. Information with validity information for the respective period of time ranks higher than information without validity information.\n2. Among conflicting nodes both having validity information, the one with the shorter validity span ranks higher.\nNote 2: For Google, attaching a gr:validThrough statement to a gr:UnitPriceSpecification is mandatory. \n"},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#Offering", "http://purl.org/goodrelations/v1#OpeningHoursSpecification", "http://purl.org/goodrelations/v1#PriceSpecification", "http://purl.org/goodrelations/v1#License", term(
            subClassOf: "http://purl.org/goodrelations/v1#Offering",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "valid through (0..1)"},
      range: "http://www.w3.org/2001/XMLSchema#dateTime",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :valueAddedTaxIncluded,
      comment: {en: "This property specifies whether the applicable value-added tax (VAT)  is included in the price of the gr:PriceSpecification or not.\n\nNote: This is a simple representation which may not properly reflect all details of local taxation."},
      domain: "http://purl.org/goodrelations/v1#PriceSpecification",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "value added tax included (0..1)"},
      range: "http://www.w3.org/2001/XMLSchema#boolean",
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty"
    property :valueReference,
      ...
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :vatID,
      comment: {en: "The Value-added Tax ID of the gr:BusinessEntity. See http://en.wikipedia.org/wiki/Value_added_tax_identification_number for details."},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#BusinessEntity", term(
            subClassOf: "http://purl.org/goodrelations/v1#BusinessEntity",
    ...
    property :weight,
      ...
      type: "http://www.w3.org/2002/07/owl#ObjectProperty"
    property :width,
      comment: {en: "The width of the gr:ProductOrService.\nTypical unit code(s): CMT for centimeters, INH for inches"},
      domain: term(
          type: "http://www.w3.org/2002/07/owl#Class",
          unionOf: list("http://purl.org/goodrelations/v1#ProductOrService", term(
            equivalentClass: "http://purl.org/goodrelations/v1#ProductOrService",
    ...
    term :AmericanExpress,
      comment: {en: "Payment by credit or debit cards issued by the American Express network."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "American Express (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethodCreditCard"
    term :Business,
      comment: {en: "The gr:BusinessEntityType representing such agents that are themselves offering commercial services or products on the market. Usually, businesses are characterized by the fact that they are officially registered with the public administration and strive for profits by their activities."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Business (business entity type)"},
      type: "http://purl.org/goodrelations/v1#BusinessEntityType"
    term :Buy,
      comment: {en: "This gr:BusinessFunction indicates that the gr:BusinessEntity is in general interested in purchasing the specified gr:ProductOrService.\nDEPRECATED. Use gr:seeks instead."},
      "http://www.w3.org/2002/07/owl#deprecated": "true",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Buy (business function, DEPRECATED)"},
      type: "http://purl.org/goodrelations/v1#BusinessFunction"
    term :ByBankTransferInAdvance,
      comment: {en: "Payment by bank transfer in advance, i.e., the offering gr:BusinessEntity will inform the buying party about their bank account details and will deliver the goods upon receipt of the due amount.\nThis is equivalent to payment by wire transfer."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "By bank transfer in advance (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethod"
    term :ByInvoice,
      comment: {en: "Payment by bank transfer after delivery, i.e., the offering gr:BusinessEntity will deliver first, inform the buying party about the due amount and their bank account details, and expect payment shortly after delivery."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "By invoice (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethod"
    term :COD,
      comment: {en: "Collect on delivery / Cash on delivery - A payment method where the recipient of goods pays at the time of delivery. Usually, the amount of money is collected by the transportation company handling the goods."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "COD (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethod"
    term :Cash,
      comment: {en: "Payment by cash upon delivery or pickup."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Cash (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethod"
    term :CheckInAdvance,
      comment: {en: "Payment by sending a check in advance, i.e., the offering gr:BusinessEntity will deliver the goods upon receipt of a check over the due amount. There are variations in handling payment by check - sometimes, shipment will be upon receipt of the check as a document, sometimes the shipment will take place only upon successful crediting of the check."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Check in advance (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethod"
    term :ConstructionInstallation,
      comment: {en: "This gr:BusinessFunction indicates that the gr:BusinessEntity offers (or seeks) the construction and/or installation of the specified gr:ProductOrService at the customer's location."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Construction / installation (business function)"},
      type: "http://purl.org/goodrelations/v1#BusinessFunction"
    term :DHL,
      comment: {en: "Delivery via the parcel service DHL."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "DHL (delivery method)"},
      type: "http://purl.org/goodrelations/v1#DeliveryModeParcelService"
    term :DeliveryModeDirectDownload,
      comment: {en: "Delivery of the goods via direct download from the Internet, i.e., the offering gr:BusinessEntity provides the buying party with details on how to retrieve the goods online. Connection fees and other costs of using the infrastructure are to be carried by the buying party."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Delivery mode direct download (delivery method)"},
      type: "http://purl.org/goodrelations/v1#DeliveryMethod"
    term :DeliveryModeFreight,
      comment: {en: "Delivery by an unspecified air, sea, or ground freight carrier or cargo company."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Delivery mode freight (delivery method)"},
      type: "http://purl.org/goodrelations/v1#DeliveryMethod"
    term :DeliveryModeMail,
      comment: {en: "Delivery via regular mail service (private or public postal services)."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Delivery mode mail (delivery method)"},
      type: "http://purl.org/goodrelations/v1#DeliveryMethod"
    term :DeliveryModeOwnFleet,
      comment: {en: "Delivery of the goods by using a fleet of vehicles either owned and operated or subcontracted by the gr:BusinessEntity."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Delivery mode own fleet (delivery method)"},
      type: "http://purl.org/goodrelations/v1#DeliveryMethod"
    term :DeliveryModePickUp,
      comment: {en: "Delivery of the goods by picking them up at one of the stores etc. (gr:Location) during the opening hours as specified by respective instances of gr:OpeningHoursSpecification."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Delivery mode pick up (delivery method)"},
      type: "http://purl.org/goodrelations/v1#DeliveryMethod"
    term :DinersClub,
      comment: {en: "Payment by credit or debit cards issued by the Diner's Club network."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Diners Club (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethodCreditCard"
    term :DirectDebit,
      comment: {en: "Payment by direct debit, i.e., the buying party will inform the offering gr:BusinessEntity about its bank account details and authorizes the gr:BusinessEntity to collect the agreed amount directly from that account."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Direct debit (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethod"
    term :Discover,
      comment: {en: "Payment by credit or debit cards issued by the Discover network."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Discover (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethodCreditCard"
    term :Dispose,
      comment: {en: "This gr:BusinessFunction indicates that the gr:BusinessEntity offers (or seeks) the acceptance of the specified gr:ProductOrService for proper disposal, recycling, or any other kind of allowed usages, freeing the current owner from all rights and obligations of ownership."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Dispose (business function)"},
      type: "http://purl.org/goodrelations/v1#BusinessFunction"
    term :Enduser,
      comment: {en: "The gr:BusinessEntityType representing such agents that are purchasing the good or service for private consumption, in particular not for resale or for usage within an industrial enterprise. By default, a Business Entity is an Enduser."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Enduser (business entity type)"},
      type: "http://purl.org/goodrelations/v1#BusinessEntityType"
    term :FederalExpress,
      comment: {en: "Delivery via the parcel service Federal Express."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Federal Express (delivery method)"},
      type: "http://purl.org/goodrelations/v1#DeliveryModeParcelService"
    term :Friday,
      comment: {en: "Friday as a day of the week."},
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Friday (day of week)"},
      type: "http://purl.org/goodrelations/v1#DayOfWeek"
    term :GoogleCheckout,
      comment: {en: "Payment via the Google Checkout payment service."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Google Checkout (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethod"
    term :JCB,
      comment: {en: "Payment by credit or debit cards issued by the JCB network."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "JCB (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethodCreditCard"
    term :"Labor-BringIn",
      comment: {en: "In case of a defect or malfunction, the buying party has the right to transport the good to a service location determined by the the selling gr:BusinessEntity and will be charged only for parts and materials needed to fix the problem. Labor will be covered by the selling business entity or one of its partnering business entities.\n\nNote: This is just a rough classification for filtering offers. It is up to the buying party to check the exact scope and terms and conditions of the gr:WarrantyPromise."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Labor / bring-in (warranty scope)"},
      type: "http://purl.org/goodrelations/v1#WarrantyScope"
    term :LeaseOut,
      comment: {en: "This gr:BusinessFunction indicates that the gr:BusinessEntity offers (or seeks) the temporary right to use the specified gr:ProductOrService."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Lease Out (business function)"},
      type: "http://purl.org/goodrelations/v1#BusinessFunction"
    term :Maintain,
      comment: {en: "This gr:BusinessFunction indicates that the gr:BusinessEntity offers (or seeks) typical maintenance tasks for the specified gr:ProductOrService. Maintenance tasks are actions that undo or compensate for wear or other deterioriation caused by regular usage, in order to restore the originally intended function of the product, or to prevent outage or malfunction."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Maintain (business function)"},
      type: "http://purl.org/goodrelations/v1#BusinessFunction"
    term :MasterCard,
      comment: {en: "Payment by credit or debit cards issued by the MasterCard network."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "MasterCard (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethodCreditCard"
    term :Monday,
      comment: {en: "Monday as a day of the week."},
    ...
    term :"PartsAndLabor-BringIn",
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Parts and labor / bring-in (warranty scope)"},
      type: "http://purl.org/goodrelations/v1#WarrantyScope"
    term :"PartsAndLabor-PickUp",
      comment: {en: "In case of a defect or malfunction, the buying party has the right to request from the selling gr:Business Entity to pick-up the good from its current location to a suitable service location, where the functionality of the good will be restored. All transportation, labor, parts, and materials needed to fix the problem will be covered by the selling business entity or one of its partnering business entities.\n  \nNote: This is just a rough classification for filtering offers. It is up to the buying party to check the exact scope and terms and conditions of the gr:WarrantyPromise."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Parts and labor / pick up (warranty scope)"},
      type: "http://purl.org/goodrelations/v1#WarrantyScope"
    term :PayPal,
      comment: {en: "Payment via the PayPal payment service."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "PayPal (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethod"
    term :PaySwarm,
      comment: {en: "Payment via the PaySwarm distributed micropayment service."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "PaySwarm (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethod"
    term :ProvideService,
      comment: {en: "This gr:BusinessFunction indicates that the gr:BusinessEntity offers (or seeks) the respective type of service.\n\nNote: Maintain and Repair are also types of Services. However, products and services ontologies often provide classes for tangible products as well as for types of services. The business function gr:ProvideService is to be used with such goods that are services, while gr:Maintain and gr:Repair can be used with goods for which only the class of product exists in the ontology, but not the respective type of service.\n\nExample: Car maintenance could be expressed both as \"provide the service car maintenance\" or \"maintain cars\"."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Provide service (business function)"},
      type: "http://purl.org/goodrelations/v1#BusinessFunction"
    term :PublicHolidays,
      comment: {en: "A placeholder for all official public holidays at the gr:Location. This allows specifying the opening hours on public holidays. If a given day is a public holiday, this specification supersedes the opening hours for the respective day of the week."},
      "http://purl.org/goodrelations/v1#displayPosition": "8",
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Public holidays (day of week)"},
      type: "http://purl.org/goodrelations/v1#DayOfWeek"
    term :PublicInstitution,
      comment: {en: "The gr:BusinessEntityType representing such agents that are part of the adminstration or owned by the public."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Public institution (business entity type)"},
      type: "http://purl.org/goodrelations/v1#BusinessEntityType"
    term :Repair,
      comment: {en: "This gr:BusinessFunction indicates that the gr:BusinessEntity offers (or seeks) the evaluation of the chances for repairing, and, if positive, repair of the specified gr:ProductOrService. Repairing means actions that restore the originally intended function of a product that suffers from outage or malfunction."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Repair (business function)"},
      type: "http://purl.org/goodrelations/v1#BusinessFunction"
    term :Reseller,
      comment: {en: "The gr:BusinessEntityType representing such agents that are purchasing the scope of products included in the gr:Offering for resale on the market. Resellers are also businesses, i.e., they are officially registered with the public administration and strive for profits by their activities."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Reseller (business entity type)"},
      type: "http://purl.org/goodrelations/v1#BusinessEntityType"
    term :Saturday,
      comment: {en: "Saturday as a day of the week."},
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Saturday (day of week)"},
      type: "http://purl.org/goodrelations/v1#DayOfWeek"
    term :Sell,
      comment: {en: "This gr:BusinessFunction indicates that the gr:BusinessEntity offers to permanently transfer all property rights on the specified gr:ProductOrService."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Sell (business function)"},
      type: "http://purl.org/goodrelations/v1#BusinessFunction"
    term :Sunday,
      comment: {en: "Sunday as a day of the week."},
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Sunday (day of week)"},
      type: "http://purl.org/goodrelations/v1#DayOfWeek"
    term :Thursday,
      comment: {en: "Thursday as a day of the week."},
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Thursday (day of week)"},
      type: "http://purl.org/goodrelations/v1#DayOfWeek"
    term :Tuesday,
      comment: {en: "Tuesday as a day of the week."},
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Tuesday (day of week)"},
      type: "http://purl.org/goodrelations/v1#DayOfWeek"
    term :UPS,
      comment: {en: "Delivery via the parcel service UPS."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "UPS (delivery method)"},
      type: "http://purl.org/goodrelations/v1#DeliveryModeParcelService"
    term :VISA,
      comment: {en: "Payment by credit or debit cards issued by the VISA network."},
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "VISA (payment method)"},
      type: "http://purl.org/goodrelations/v1#PaymentMethodCreditCard"
    term :Wednesday,
      comment: {en: "Wednesday as a day of the week."},
      ...
      isDefinedBy: "http://purl.org/goodrelations/v1",
      label: {en: "Wednesday (day of week)"},
      type: "http://purl.org/goodrelations/v1#DayOfWeek"
  end
end
