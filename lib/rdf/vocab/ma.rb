...
module RDF::Vocab
  MA = Class.new(RDF::Vocabulary("http://www.w3.org/ns/ma-ont#")) do
    ...
    property :averageBitRate,
      ...
      domain: term(
          intersectionOf: list("http://www.w3.org/ns/ma-ont#MediaResource".freeze, "_:g9880".freeze),
          type: "http://www.w3.org/2002/07/owl#Class".freeze
        ),
    ...
    property :duration,
      ...
      domain: term(
          intersectionOf: list("http://www.w3.org/ns/ma-ont#MediaResource".freeze, "_:g9940".freeze),
          type: "http://www.w3.org/2002/07/owl#Class".freeze
        ),
      range: "http://www.w3.org/2001/XMLSchema#decimal".freeze,
      type: "http://www.w3.org/2002/07/owl#DatatypeProperty".freeze
