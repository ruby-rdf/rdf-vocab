...
module RDF::Vocab
  class BIBO < RDF::StrictVocabulary("http://purl.org/ontology/bibo/")
    ...
    term :MultiVolumeBook,
      ...
      label: "Series".freeze,
      "rdfs:isDefinedBy" => %(http://purl.org/ontology/bibo/).freeze,
      subClassOf: "http://purl.org/ontology/bibo/Collection".freeze,
      type: "owl:Class".freeze,
      "vs:term_status" => %(stable).freeze
    term :Newspaper,
...
first document.).freeze,
      ...
      "owl:inverseOf" => %(http://purl.org/ontology/bibo/cites).freeze,
...
another purpose.).freeze,
    ...
    property :presents,
      ...
      label: "presented at".freeze,
      "owl:inverseOf" => %(http://purl.org/ontology/bibo/presentedAt).freeze,
      range: "http://purl.org/ontology/bibo/Document".freeze,
      "rdfs:isDefinedBy" => %(http://purl.org/ontology/bibo/).freeze,
...
15, sec. A, p. 3.).freeze,
    ...
    # Extra definitions
    term :"",
      "dc:creator" => [%(http://purl.org/ontology/bibo/bdarcus).freeze, %(http://purl.org/ontology/bibo/fgiasson).freeze],
...
sources.).freeze,
    ...
    term :"degrees/ma",
      ...
      label: "M.A.".freeze,
      type: ["http://purl.org/ontology/bibo/ThesisDegree".freeze, "owl:Thing".freeze],
      "vs:term_status" => %(stable).freeze
    term :"degrees/ms",
    ...
    term :"degrees/phd",
      ...
      type: ["owl:Thing".freeze, "http://purl.org/ontology/bibo/ThesisDegree".freeze],
      "vs:term_status" => %(stable).freeze
    term :fgiasson,
    ...
    term :"status/accepted",
      ...
      type: ["http://purl.org/ontology/bibo/DocumentStatus".freeze, "owl:Thing".freeze],
      "vs:term_status" => %(stable).freeze
    term :"status/draft",
      comment: %(Document drafted).freeze,
      label: "draft".freeze,
      type: ["owl:Thing".freeze, "http://purl.org/ontology/bibo/DocumentStatus".freeze],
      "vs:term_status" => %(stable).freeze
