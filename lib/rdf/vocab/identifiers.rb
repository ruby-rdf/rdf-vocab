...
module RDF::Vocab
  ...
  Identifiers = Class.new(RDF::StrictVocabulary("http://id.loc.gov/vocabulary/identifiers/")) do
    ...
    term :hdl,
      ...
      type: "http://www.loc.gov/mads/rdf/v1#Authority"
    term :iaafa,
      "http://www.loc.gov/mads/rdf/v1#authoritativeLabel": "IAAF athletes",
      type: "http://www.loc.gov/mads/rdf/v1#Authority"
    term :ibdb,
