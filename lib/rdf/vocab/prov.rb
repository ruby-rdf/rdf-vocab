...
module RDF::Vocab
  ...
  class PROV < RDF::StrictVocabulary("http://www.w3.org/ns/prov#")
    ...
    term :ActivityInfluence,
      comment: [%(It is not recommended that the type ActivityInfluence be asserted without also asserting one of its more specific subclasses.).freeze, %(ActivityInfluence provides additional descriptions of an Activity's binary influence upon any other kind of resource. Instances of ActivityInfluence use the prov:activity property to cite the influencing Activity.).freeze],
    ...
    term :Agent,
      ...
      type: "owl:Class".freeze
    term :AgentInfluence,
      comment: [%(It is not recommended that the type AgentInfluence be asserted without also asserting one of its more specific subclasses.).freeze, %(AgentInfluence provides additional descriptions of an Agent's binary influence upon any other kind of resource. Instances of AgentInfluence use the prov:agent property to cite the influencing Agent.).freeze],
...
For example, a student acted on behalf of his supervisor, who acted on behalf of the department chair, who acted on behalf of the university; all those agents are responsible in some way for the activity that took place but we do not say explicitly who bears responsibility and to what degree.).freeze,
    ...
    term :EmptyCollection,
      ...
      type: ["owl:NamedIndividual".freeze, "owl:Class".freeze]
    ...
    term :End,
      ...
      :"rdfs:isDefinedBy" => %(http://www.w3.org/ns/prov-o#).freeze,
      subClassOf: ["prov:InstantaneousEvent".freeze, "prov:EntityInfluence".freeze],
      type: "owl:Class".freeze
    term :Entity,
      label: "Entity".freeze,
      :"owl:disjointWith" => %(prov:InstantaneousEvent).freeze,
    ...
    term :Generation,
      ...
      :"rdfs:isDefinedBy" => %(http://www.w3.org/ns/prov-o#).freeze,
      subClassOf: ["prov:InstantaneousEvent".freeze, "prov:ActivityInfluence".freeze],
      type: "owl:Class".freeze
    term :Influence,
      comment: [%(Because prov:Influence is a broad relation, its most specific subclasses \(e.g. prov:Communication, prov:Delegation, prov:End, prov:Revision, etc.\) should be used when applicable.).freeze, %(An instance of prov:Influence provides additional descriptions about the binary prov:wasInfluencedBy relation from some influenced Activity, Entity, or Agent to the influencing Activity, Entity, or Agent. For example, :stomach_ache prov:wasInfluencedBy :spoon; prov:qualifiedInfluence [ a prov:Influence; prov:entity :spoon; :foo :bar ] . Because prov:Influence is a broad relation, the more specific relations \(Communication, Delegation, End, etc.\) should be used when applicable.).freeze],
...
When :x prov:mentionOf :y and :y is described in Bundle :b, the triple :x prov:asInBundle :b is also asserted to cite the Bundle in which :y was described.).freeze,
    ...
    property :atLocation,
      ...
      :"prov:category" => %(expanded).freeze,
      :"prov:editorialNote" => [%(This property is not functional because the many values could be at a variety of granularies \(In this building, in this room, in that chair\).).freeze, %(The naming of prov:atLocation parallels prov:atTime, and is not named prov:hadLocation to avoid conflicting with the convention that prov:had* properties are used on prov:Influence classes.).freeze],
    ...
    property :atTime,
      ...
      :"prov:unqualifiedForm" => [%(prov:generatedAtTime).freeze, %(prov:invalidatedAtTime).freeze, %(prov:startedAtTime).freeze, %(prov:endedAtTime).freeze],
    ...
    property :hadActivity,
      comment: [%(This property has multiple RDFS domains to suit multiple OWL Profiles. See <a href="#owl-profile">PROV-O OWL Profile</a>.).freeze, %(The _optional_ Activity of an Influence, which used, generated, invalidated, or was the responsibility of some Entity. This property is _not_ used by ActivityInfluence \(use prov:activity instead\).).freeze],
    ...
    property :hadPrimarySource,
      ...
      :"prov:qualifiedForm" => [%(prov:qualifiedPrimarySource).freeze, %(prov:PrimarySource).freeze],
      range: "prov:Entity".freeze,
      :"rdfs:isDefinedBy" => %(http://www.w3.org/ns/prov-o#).freeze,
      subPropertyOf: "prov:wasDerivedFrom".freeze,
      type: "owl:ObjectProperty".freeze
    property :hadRole,
      comment: [%(This property has multiple RDFS domains to suit multiple OWL Profiles. See <a href="#owl-profile">PROV-O OWL Profile</a>.).freeze, %(The _optional_ Role that an Entity assumed in the context of an Activity. For example, :baking prov:used :spoon; prov:qualified [ a prov:Usage; prov:entity :spoon; prov:hadRole roles:mixing_implement ].).freeze],
      domain: "prov:Influence".freeze,
...
Note how the value of the unqualified influence \(prov:wasGeneratedBy :activity1\) is mirrored as the value of the prov:activity \(or prov:entity, or prov:agent\) property on the influence class.).freeze,
    ...
    property :specializationOf,
      ...
      type: ["owl:ObjectProperty".freeze, "owl:AnnotationProperty".freeze]
    ...
    property :value,
      ...
      :"prov:editorialNote" => [%(This property serves the same purpose as rdf:value, but has been reintroduced to avoid some of the definitional ambiguity in the RDF specification \(specifically, 'may be used in describing structured values'\).).freeze, %(The editor's definition comes from http://www.w3.org/TR/rdf-primer/#rdfvalue).freeze],
      :"rdfs:isDefinedBy" => %(http://www.w3.org/ns/prov-o#).freeze,
      type: "owl:DatatypeProperty".freeze
    ...
    property :wasAttributedTo,
      ...
      :"prov:qualifiedForm" => [%(prov:qualifiedAttribution).freeze, %(prov:Attribution).freeze],
      range: "prov:Agent".freeze,
      :"rdfs:isDefinedBy" => %(http://www.w3.org/ns/prov-o#).freeze,
      subPropertyOf: "prov:wasInfluencedBy".freeze,
      type: "owl:ObjectProperty".freeze
    ...
    property :wasEndedBy,
      ...
      :"prov:qualifiedForm" => [%(prov:qualifiedEnd).freeze, %(prov:End).freeze],
      range: "prov:Entity".freeze,
      :"rdfs:isDefinedBy" => %(http://www.w3.org/ns/prov-o#).freeze,
      subPropertyOf: "prov:wasInfluencedBy".freeze,
      type: "owl:ObjectProperty".freeze
    property :wasGeneratedBy,
      ...
      :"prov:qualifiedForm" => [%(prov:qualifiedGeneration).freeze, %(prov:Generation).freeze],
      range: "prov:Activity".freeze,
      :"rdfs:isDefinedBy" => [%(http://www.w3.org/ns/prov-o#).freeze, %(http://www.w3.org/ns/prov-o-inverses#).freeze],
      subPropertyOf: "prov:wasInfluencedBy".freeze,
      type: "owl:ObjectProperty".freeze
...
prov:wasInfluencedBy should not be used without also using one of its subproperties. 
    ...
    property :wasInformedBy,
      ...
      :"prov:qualifiedForm" => [%(prov:qualifiedCommunication).freeze, %(prov:Communication).freeze],
      range: "prov:Activity".freeze,
      :"rdfs:isDefinedBy" => %(http://www.w3.org/ns/prov-o#).freeze,
      subPropertyOf: "prov:wasInfluencedBy".freeze,
      type: "owl:ObjectProperty".freeze
    property :wasInvalidatedBy,
      ...
      :"prov:qualifiedForm" => [%(prov:qualifiedInvalidation).freeze, %(prov:Invalidation).freeze],
      range: "prov:Activity".freeze,
      :"rdfs:isDefinedBy" => [%(http://www.w3.org/ns/prov-o#).freeze, %(http://www.w3.org/ns/prov-o-inverses#).freeze],
      subPropertyOf: "prov:wasInfluencedBy".freeze,
      type: "owl:ObjectProperty".freeze
    ...
    property :wasRevisionOf,
      ...
      :"prov:qualifiedForm" => [%(prov:qualifiedRevision).freeze, %(prov:Revision).freeze],
      range: "prov:Entity".freeze,
      :"rdfs:isDefinedBy" => %(http://www.w3.org/ns/prov-o#).freeze,
      subPropertyOf: "prov:wasDerivedFrom".freeze,
      type: ["owl:ObjectProperty".freeze, "owl:AnnotationProperty".freeze]
...
Archives/Public/public-prov-comments/\). All feedback is welcome.).freeze,
      ...
      :"owl:imports" => [%(http://www.w3.org/ns/prov-aq#).freeze, %(http://www.w3.org/ns/prov-o#).freeze, %(http://www.w3.org/ns/prov-o-inverses#).freeze, %(http://www.w3.org/ns/prov-dc#).freeze, %(http://www.w3.org/ns/prov-links#).freeze, %(http://www.w3.org/ns/prov-dictionary#).freeze],
      ...
      :"prov:wasDerivedFrom" => [%(http://www.w3.org/ns/prov-aq#).freeze, %(http://www.w3.org/ns/prov-o-20130430).freeze, %(http://www.w3.org/ns/prov-o#).freeze, %(http://www.w3.org/ns/prov-o-inverses#).freeze, %(http://www.w3.org/ns/prov-dc#).freeze, %(http://www.w3.org/ns/prov-links#).freeze, %(http://www.w3.org/ns/prov-dictionary#).freeze],
      :"prov:wasRevisionOf" => [%(http://www.w3.org/ns/prov-o-inverses-20120312).freeze, %(http://www.w3.org/ns/prov-20130312).freeze],
