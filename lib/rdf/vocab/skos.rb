...
module RDF::Vocab
  ...
  class SKOS < RDF::StrictVocabulary("http://www.w3.org/2004/02/skos/core#")
    ...
    property :altLabel,
      comment: [%(skos:prefLabel, skos:altLabel and skos:hiddenLabel are pairwise disjoint properties.).freeze, %(The range of skos:altLabel is the class of RDF plain literals.).freeze],
    ...
    property :broaderTransitive,
      ...
      type: ["rdf:Property".freeze, "owl:ObjectProperty".freeze, "owl:TransitiveProperty".freeze]
    property :changeNote,
    ...
    property :hiddenLabel,
      comment: [%(skos:prefLabel, skos:altLabel and skos:hiddenLabel are pairwise disjoint properties.).freeze, %(The range of skos:hiddenLabel is the class of RDF plain literals.).freeze],
    ...
    property :narrowMatch,
      ...
      subPropertyOf: ["skos:narrower".freeze, "skos:mappingRelation".freeze],
      type: ["rdf:Property".freeze, "owl:ObjectProperty".freeze]
    property :narrower,
    ...
    property :relatedMatch,
      ...
      subPropertyOf: ["skos:related".freeze, "skos:mappingRelation".freeze],
      type: ["rdf:Property".freeze, "owl:SymmetricProperty".freeze, "owl:ObjectProperty".freeze]
    property :scopeNote,
