...
module RDF::Vocab
  ...
  class SKOSXL < RDF::StrictVocabulary("http://www.w3.org/2008/05/skos-xl#")
    ...
    term :Label,
      label: "Label".freeze,
      :"owl:disjointWith" => [%(skos:Concept).freeze, %(skos:ConceptScheme).freeze, %(skos:Collection).freeze],
    ...
    property :literalForm,
      comment: [%(The range of skosxl:literalForm is the class of RDF plain literals.).freeze, %(If two instances of the class skosxl:Label have the same literal form, they are not necessarily the same resource.).freeze],
      domain: "skosxl:Label".freeze,
