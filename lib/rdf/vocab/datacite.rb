...
[2] - http://sempublishing.svn.sourceforge.net/viewvc/sempublishing/DataCite/RDF_mapping-of-DataCitev2.2-XML_example.docx).freeze],
    ...
    term :nihmsid,
      ...
      type: ["datacite:ResourceIdentifierScheme".freeze, "owl:NamedIndividual".freeze]
    term :nii,
      label: ["nii".freeze, "National Individual Identifier scheme".freeze],
      type: ["owl:NamedIndividual".freeze, "datacite:PersonalIdentifierScheme".freeze]
    term :openid,
    ...
    term :"series-information",
      ...
      :"rdfs:seeAlso" => [%(http://purl.org/spar/fabio/Periodical).freeze, %(http://purl.org/spar/fabio/BookSeries).freeze],
      type: ["owl:NamedIndividual".freeze, "datacite:DescriptionType".freeze]
    term :sici,
