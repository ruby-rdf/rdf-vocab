...
module RDF::Vocab
  class DataCite < RDF::StrictVocabulary("http://purl.org/spar/datacite/")
    ...
    term :AlternateResourceIdentifier,
      ...
      "owl:disjointWith" => %(http://purl.org/spar/datacite/PrimaryResourceIdentifier).freeze,
    ...
    term :FunderIdentifier,
      ...
      subClassOf: "http://purl.org/spar/datacite/Identifier".freeze,
      type: "owl:Class".freeze
    term :FunderIdentifierScheme,
      ...
      subClassOf: "http://purl.org/spar/datacite/IdentifierScheme".freeze,
      type: "owl:Class".freeze
    term :Identifier,
...
[2] - http://sempublishing.svn.sourceforge.net/viewvc/sempublishing/DataCite/RDF_mapping-of-DataCitev2.2-XML_example.docx).freeze, %(https://svn.code.sf.net/p/sempublishing/code/DataCite/datacite.png).freeze],
    ...
    term :abstract,
      ...
      type: ["owl:NamedIndividual".freeze, "http://purl.org/spar/datacite/DescriptionType".freeze]
    term :ark,
      comment: %(Archival Resource Key.).freeze,
      label: "ark".freeze,
      "rdfs:isDefinedBy" => %(https://confluence.ucop.edu/display/Curation/ARK).freeze,
      type: ["owl:NamedIndividual".freeze, "http://purl.org/spar/datacite/ResourceIdentifierScheme".freeze]
    term :arxiv,
    ...
    term :dia,
      ...
      type: ["owl:NamedIndividual".freeze, "http://purl.org/spar/datacite/PersonalIdentifierScheme".freeze]
    term :doi,
    ...
    term :fundref,
      ...
      type: ["owl:NamedIndividual".freeze, "http://purl.org/spar/datacite/FunderIdentifierScheme".freeze]
    term :handle,
